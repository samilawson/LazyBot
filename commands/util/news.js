...
module.exports = class NewsCommand extends Command {
  ...
  async run(msg, args) {
    ...
    embed.setColor(3447003)
         ...
         .addField(`\u200b`,`**[${res.articles[0]['title']}](${res.articles[0]['url']})**`, true)
         .addField(`\u200b`,`**[${res.articles[1]['title']}](${res.articles[1]['url']})**`, true)
         .addField(`\u200b`,`**[${res.articles[2]['title']}](${res.articles[2]['url']})**`, true)
         .addField(`\u200b`,`**[${res.articles[3]['title']}](${res.articles[3]['url']})**`, true)
         .addField(`\u200b`,`**[${res.articles[4]['title']}](${res.articles[4]['url']})**`, true)
